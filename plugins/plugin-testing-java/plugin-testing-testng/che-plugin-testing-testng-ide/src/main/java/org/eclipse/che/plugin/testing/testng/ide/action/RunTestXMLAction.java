...
public class RunTestXMLAction extends AbstractPerspectiveAction
  ...
  public RunTestXMLAction(
    ...
    super(
        ...
        localization.actionRunXMLTitle(),
        localization.actionRunXMLDescription(),
        null,
        resources.testAllIcon());
    ...
    if (resource != null) {
      ...
      if (project != null) {
        ...
        parameters.put(
            ...
            project.getPath()
                + "/"
                + MavenAttributes.DEFAULT_TEST_RESOURCES_FOLDER
                + "/testng.xml");
